package ru.mirea.danilov.mireaproject.ui.recorder;
...
import ru.mirea.danilov.mireaproject.databinding.FragmentRecorderBinding;
...
public class RecorderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        startRecordButton = binding.startRecord;
        stopRecordButton = binding.stopRecord;
        binding.startRecord.setOnClickListener(this::onRecordStart);
        binding.stopRecord.setOnClickListener(this::onStopRecord);
        binding.listenRecord.setOnClickListener(this::onListenRecord);
    ...
    private File createRecordFile() throws IOException {
        ...
        return new File(getActivity().getExternalFilesDir(Environment.DIRECTORY_MUSIC), recordFileName);
    }

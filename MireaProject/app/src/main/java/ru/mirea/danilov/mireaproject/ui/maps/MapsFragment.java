...
import ru.mirea.danilov.mireaproject.databinding.FragmentMapsBinding;

public class MapsFragment extends Fragment implements DrivingSession.DrivingRouteListener, GeoObjectTapListener, InputListener {
    ...
    private void setMarks(){
        mapObjects = mapView.getMap().getMapObjects().addCollection();
        placeNewMark("Вернадка", "Основное, самое крутое здание", "г. Москва, Проспект Вернадского, д. 78", new Point(55.669945, 37.479492));
        placeNewMark("Вернадка", "Тут чё-то химичат", "г. Москва, Проспект Вернадского, д. 86", new Point(55.661445, 37.477049));
        placeNewMark("Стромынка", "Мама, я здесь учусь!", "г. Москва, ул. Стромынка, д.20", new Point(55.794259, 37.701448));
    }
